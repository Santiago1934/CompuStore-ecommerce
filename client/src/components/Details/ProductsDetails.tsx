          ...
          >
            ...
            <div className={Rstyles.SortDisaster}>
              ...
              {editMode
                ...
                : 
                <div className={Rstyles.PDetails}> {/* {
                  details?.categories?.map((category) => (
        ...
        <div className={Rstyles.SortEnd} >
          ...
          {user?.privilege === "user" ? (
            ...
            <h3 className={Rstyles.TiReview} >Valoramos tu opinión</h3>
                ...
                {hideRating && revActual.length === 0 ? (
                  <div className={styles.estrellas}>
                    {[...Array(5)].map((star, index) => {
                      ...
                      return (
                        <label  className={styles.ratingStar}>
                          <input
                         ...
                         {/*  <FaStar
                            ...
                            color={ratingvalue <= hover ? "#ffc107" : "#f5dd90"}
              ...
              <div className={Rstyles.SortReview} >
                {reviewuser.review !== '' && reviewuser.title !== '' && hideReview ? (
